...
class Operations:
    ...
    def __str__(self):
        return f"size: {self.size}, filter: {self.color_filter}, " \
               ...
               f"flip-left: {self.flip_left} flip-top: {self.flip_top}"\
    ...
    def on_width_change(self, e):
        ...
        if self.ratio_check.isChecked():
            r_height = _get_ratio_height(_img_original.width,
                                         _img_original.height,
                                         int(self.width_box.text()))
...
class AdjustingTab(QWidget):
    ...
    def on_brightness_slider_released(self):
        ...
        factor = _get_converted_point(SLIDER_MIN_VAL, SLIDER_MAX_VAL,
                                      img_helper.BRIGHTNESS_FACTOR_MIN,
                                      img_helper.BRIGHTNESS_FACTOR_MAX,
    ...
    def on_sharpness_slider_released(self):
        ...
        factor = _get_converted_point(SLIDER_MIN_VAL, SLIDER_MAX_VAL,
                                      img_helper.SHARPNESS_FACTOR_MIN,
                                      img_helper.SHARPNESS_FACTOR_MAX,
    ...
    def on_contrast_slider_released(self):
        ...
        factor = _get_converted_point(SLIDER_MIN_VAL, SLIDER_MAX_VAL,
                                      img_helper.CONTRAST_FACTOR_MIN,
                                      img_helper.CONTRAST_FACTOR_MAX,
...
class MainLayout(QVBoxLayout):
    ...
    def __init__(self, parent):
        ...
        self.img_lbl = QLabel(
            ...
            "<div style='margin: 30px 0'><img src='LogoAlatoo.png' /></div>"
            "<b>made with Omurbek</b> <span style='color:red'>&#10084;</span>")
...
class EasyPzUI(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Final Project - Photo Editor')
        self.center()
        self.show()
